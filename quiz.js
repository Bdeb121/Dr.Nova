...
function setQuestion() {
    ...
    // latex.innerHTML = currentQues.question;
    // text.appendChild(latex);
    // text.appendChild(latex.cloneNode(true));
    // text.innerHTML = currentQues.question;
    // setTimeout(async function () {
    //     await MathJax.typesetPromise();
    //     // text.appendChild(done.cloneNode(true));
    // }, 0);
    // }
